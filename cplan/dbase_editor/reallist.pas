...
type
    ...
    FloatDataType = trueFloattype;

    pFloatNode_T = ^FloatNode_T;
    FloatNode_T = record
               Data : FloatDataType;
               pNext : pFloatNode_T;
                    {HERE ADD ANY OTHER
    ...
    ListFloat_O = class
                  pHead,
                  pCurrent : pFloatNode_T;

                  constructor init;
                  Function  AddNode(Data : FloatDataType) : boolean;
                  Function  DeleteNode : boolean;
                  Function  AmmendData(Data : FloatDataType) : boolean;
                  Function  ReadData   : FloatDataType;
                  ...
                  function  FindPrevNode(pNode : pFloatNode_T) : pFloatNode_T;
                  destructor clear;

                  procedure NewHead(Data : FloatDataType);
                end;
...
uses
  ...
  {xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}
  Function ListFloat_o.AddNode(Data : FloatDataType) : boolean;
  var
    pTemp : pFloatNode_T;
  begin
    AddNode := True;
    pTemp := new(pFloatNode_T);
    if pTemp <> nil then
  ...
  {xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}
  Function ListFloat_o.AmmendData(Data : FloatDataType) : boolean;
  begin
    AmmendData := True;
    if pCurrent <> nil then
      pCurrent^.Data := Data
  ...
  {xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}
  Function ListFloat_o.ReadData : FloatDataType;
  begin
    if pCurrent <> nil then
  ...
  function ListFloat_o.FindPrevNode(pNode : pFloatNode_T) : pFloatNode_T;
...
procedure ListFloat_o.NewHead(Data : FloatDataType);
var
   pTemp : pFloatNode_T;
begin
     new(pTemp);
...
var
   ...
   test, value, original : FloatDataType;
   x : longint;
   flag : boolean;
begin
     try
        ...
        Result.init(sizeof(FloatDataType),unsortedarray_c.lMaxSize);
        SortedList.init;
