...
type
  TMarZoneSystemTestForm = class(TForm)
    ...
    procedure ExecuteMarZoneTest(sInputDat, sTestConfigurations, sTranspose : string);
    procedure ExecuteMarxanTest(sInputDat, sTestConfigurations, sTranspose : string);
    procedure ExecuteMarProbThreatTest(sInputDat, sTestConfigurations, sTranspose : string);
...
procedure TMarZoneSystemTestForm.ExecuteMarZoneTest(sInputDat, sTestConfigurations, sTranspose : string);
var
...
begin
     ...
     TestConfigurationChild := TMDIChild(SCPForm.rtnChild(sTranspose));
...
procedure TMarZoneSystemTestForm.ExecuteMarxanTest(sInputDat, sTestConfigurations, sTranspose : string);
var
   sInputDir, sPuName, sSpecName, sPuvsprName, sBoundName,
   sInputDirectory, sTestResultFileName, sOutputDir, sScenName, sPenaltyFileName : string;
...
procedure TMarZoneSystemTestForm.ExecuteMarProbThreatTest(sInputDat, sTestConfigurations, sTranspose : string);
var
   sInputDir, sPuName, sSpecName, sPuvsprName, sBoundName,
   sInputDirectory, sTestResultFileName, sOutputDir, sScenName, sPenaltyFileName : string;
   fBound, fOverallTargetsInUse, fPenalty : boolean;
...
var
   sTestConfigurations, sTranspose : string;
   AChild : TMDIChild;
begin
     ...
     begin
          ...
          sTranspose := SCPForm.TransposeTable(AChild);
     end
     else
         sTranspose := sTestConfigurations;

     case RadioSoftwareTestType.ItemIndex of
          0 : ExecuteMarZoneTest(EditInputDat.Text,sTestConfigurations,sTranspose);
          1 : ExecuteMarxanTest(EditInputDat.Text,sTestConfigurations,sTranspose);
          2 : ExecuteMarProbThreatTest(EditInputDat.Text,sTestConfigurations,sTranspose);
     end;
end;
